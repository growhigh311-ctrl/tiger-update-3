...
const services = [
  { id: 'cricket-betting', title: 'Cricket Betting', emoji: '🏏', color: 'from-blue-900/40 to-black' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {services.map((service) => (
            ...
            >
              <div className={`bg-gradient-to-b ${service.color} border border-gray-800 group-hover:border-blue-500/50 rounded-2xl p-6 text-center transition-all duration-300`}>
                {/* Icon */}
                ...
                {/* Divider */}
                <div className="w-8 h-px bg-blue-500/40 group-hover:w-full transition-all duration-500 mx-auto mb-3"></div>

                {/* Title */}
                <h3 className="text-white text-sm font-bold group-hover:text-blue-400 transition-colors duration-300 leading-tight">
                  {service.title}
                </h3>
